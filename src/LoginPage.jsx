...
function LoginPage() {
  ...
  const userRegistration = () => {
    ...
    fetch("http://ec2-44-220-144-119.compute-1.amazonaws.com:8080/users/insert", {
      method: "POST",
  ...
  const signIn = () => {
    ...
    fetch("http://ec2-44-220-144-119.compute-1.amazonaws.com:8080/users/signin", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: data,
    })
      ...
      .then((res) => {
        ...
        if (resData[0] === "200") {
          ...
          fetch("http://ec2-44-220-144-119.compute-1.amazonaws.com:8080/users/getusername", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
